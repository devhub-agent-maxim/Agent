...
describe('Security Headers', () => {
  ...
  it('should apply security headers to web UI endpoint', async () => {
  ...
  it('should apply security headers to all API endpoints', async () => {
    const endpoints = ['/api/logs', '/api/goals', '/api/workers', '/api/metrics'];
